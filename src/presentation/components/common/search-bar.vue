...
<template>
  <div class="relative w-full">
    ...
    <button
      ...
      class="absolute inset-y-0 right-0 flex items-center pr-3 text-slate-500 transition-colors hover:text-slate-950 dark:text-slate-400 dark:hover:text-white"
      @click="handleClear"
    >
