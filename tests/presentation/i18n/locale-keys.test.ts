...
const EXPECTED_KEYS = [
  ...
  'person.backToHome',
  'person.biography',
  'person.biographyEmpty',
  'person.born',
  'person.creditsEmpty',
  'person.died',
  'person.error',
  'person.error.network',
  'person.error.server',
  'person.external.imdb',
  'person.external.instagram',
  'person.external.twitter',
  'person.externalLinks',
  'person.filmography',
  'person.filmographyCount',
  'person.info',
  'person.media.movie',
  'person.media.tv',
  'person.notFound',
  ...
  'recommendations.becauseYouWantToWatch',
