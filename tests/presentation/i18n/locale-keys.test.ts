...
const EXPECTED_KEYS = [
  ...
  'library.filters.status.all',
  'library.filters.status.none',
  'library.filters.status.watched',
  'library.filters.status.watchlist',
  ...
  'stats.charts.genre.title',
  'stats.charts.monthly.label',
  'stats.charts.monthly.title',
  'stats.description',
  'stats.empty.description',
  'stats.empty.title',
  'stats.metrics.avgRating',
  'stats.metrics.totalTime',
  'stats.metrics.watched',
  'stats.metrics.watchlist',
  'stats.title',
