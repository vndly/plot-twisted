...
- **Options**:
  ...
  2. **Fix all warnings & suggestions** — "Auto-fix all warnings and suggestions, triage only critical individually"
  3. **Fix all warnings** — "Auto-fix all warnings, triage critical and suggestions individually"
  4. **Fix all suggestions** — "Auto-fix all suggestions, triage critical and warnings individually"
  5. **Skip all suggestions** — "Skip all suggestions, triage critical and warnings individually"
  6. **Ignore all suggestions** — "Discard all suggestions, triage critical and warnings individually"

Apply the user's batch choice to the relevant severity levels, then proceed with item-by-item triage for the remaining findings. If a severity level has no findings, omit its batch options.
