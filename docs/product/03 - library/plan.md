...
## Phase 7: Library Search - Test Contracts
...
## Phase 8: Library Search - Domain and Application Implementation
...
4. [x] **Run targeted application/domain tests**: Run the Phase 7 domain/application tests and fix only issues within the Library search scope.

## Phase 9: Library Search - Presentation and i18n Implementation
...
5. [x] **Run targeted presentation tests**: Run the Phase 7 presentation tests and fix only Library search regressions.

## Phase 10: Library Search - Regression Verification
...
## Phase 11: Library Search - Final Verification

1. [x] **Format**: Run `npm run format`.
2. [x] **Lint**: Run `npm run lint`.
3. [x] **Type-check**: Run `npm run type-check`.
4. [x] **Full test suite**: Run `npm run test`.
5. [x] **Build**: Run `npm run build`.
