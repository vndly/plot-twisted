...
**Production dependencies:** `vue@^3.5.13`, `zod@^4.3.6`, `lucide-vue-next@^0.577.0`, `vue-i18n@^11.3.0`

**Dev dependencies:** `typescript@~5.9.3`, `vite@^8.0.1`, `vitest@^4.1.0`, `@vitejs/plugin-vue@^6.0.5`, `@tailwindcss/vite@^4.1.3`, `tailwindcss@^4.1.3`, `@intlify/unplugin-vue-i18n@^11.0.7`, `eslint@^10.1.0`, `@eslint/js@^10.0.1`, `typescript-eslint@^8.25.0`, `eslint-plugin-vue@^10.8.0`, `eslint-config-prettier@^10.1.1`, `prettier@^3.5.3`, `vue-tsc@^3.2.6`, `jsdom@^29.0.1`
