...
| ED-08 | Watch Status     | A watch status control SHALL allow the user to set `LibraryEntry.status` to one of: `watchlist`, `watched`, or `none`. The control SHALL display the current status and allow cycling through states or provide a dropdown/toggle UI.                                                                                                                                                                                                                                                           | P0       |
...
| ED-13 | Provider Rating  | The provider's vote average (`vote_average`) SHALL be displayed as a badge, formatted to one decimal place (e.g., "8.4").                                                                                                                                                                                                                                                                                                                                                                       | P1       |
...
- [ ] Provider rating badge displays vote average formatted to one decimal (ED-13)
