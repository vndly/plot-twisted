...
- **Risk: Pagination Overhead**: Fetching multiple pages to cover a month might impact performance. _Mitigation_: Stop fetching once dates exceed the visible month; use skeleton loaders.
- **Risk: Regional Data Gaps**: Some regions may have significantly less "upcoming" data than others. _Mitigation_: Clear empty state message (FR-06-06).
